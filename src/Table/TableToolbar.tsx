import { Button, IconButton, Theme, Toolbar, Tooltip, createStyles } from '@material-ui/core'
...
export function TableToolbar<T extends object>({
  ...
  const hideableColumns = columns.filter((column: { id: string }) => !(column.id === '_selector'))
